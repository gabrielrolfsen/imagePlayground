...
{
	[Activity (Label = "DraggableRectangleView")]			
	public class DraggableRectangleView : View
	{
		...
		public DraggableRectangleView(Context ctx) : base (ctx){
			init (ctx);
		}

		public DraggableRectangleView (Context ctx, IAttributeSet attrs) : base (ctx, attrs){
			init (ctx);
		}

		public DraggableRectangleView (Context ctx, IAttributeSet attrs, int defStyle) : base(ctx,attrs,defStyle){
			init (ctx);
		}
